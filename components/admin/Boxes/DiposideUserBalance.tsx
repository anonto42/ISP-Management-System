...
const DiposideUserBalance = ({
  ...
  return (
    <div className='z-10 absolute top-[50%] left-[50%] w-full h-full bg-[#0000002c] transform -translate-x-[50%] -translate-y-[50%] flex justify-center items-center'>
        <div className='w-[300px] mx-auto bg-[#F7F7F7]'>
            <div className='text-lg font-semibold p-3 border-b border-gray-300 flex items-center justify-between'>
                <h1>Diposide</h1>
            ...
            <div className='px-3 py-3'>
                <input 
                    className='set_inp_ text-sm'
                    type="text"
                    placeholder='Amount' />
                <input 
                    className='set_inp_ text-sm mt-3'
                    type="text"
